...
function bakeshop_init(){
  ...
  register_post_type('Debi Bakes', $args);
}
add_action('init', 'bakeshop_init');

// Create the shortcode for the bookstore post-type
function bakeshop_shortcode(){
  $query = new WP_Query(array('post_type' => 'Debi Bakes', 'post_per_page' => 12, 'order' => 'asc'));
  while ($query -> have_posts()) : $query-> the_post(); ?>
    <div class="col-sm-12 col-md-6 col-lg-3">
      <div class="image-container">
        <a href="<?php the_permalink(); ?>"><?php the_post_thumbnail(); ?></a>
      </div>
      <div class="bakeshop_content">
        <h4><?php the_title(); ?></h4>
        <?php the_excerpt(); ?>
...
add_shortcode('bakeshop', 'bakeshop_shortcode');
